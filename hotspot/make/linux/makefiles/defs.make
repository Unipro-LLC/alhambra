...
ifeq ($(JDK6_OR_EARLIER),0)
  ...
  ifneq ($(BUILD_FLAVOR),)
    ...
    else ifeq ($(JVM_VARIANT_ALHAMBRA), true)
      ENABLE_FULL_DEBUG_SYMBOLS = $(FULL_DEBUG_SYMBOLS)
    else
...
ifeq ($(findstring true, $(JVM_VARIANT_SERVER) $(JVM_VARIANT_ZERO) $(JVM_VARIANT_ALHAMBRA) $(JVM_VARIANT_ZEROSHARK) $(JVM_VARIANT_CORE)), true)
