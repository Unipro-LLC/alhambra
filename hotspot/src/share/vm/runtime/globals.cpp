...
#ifdef LLVM
#define LLVM_PRODUCT_FLAG_STRUCT(       type, name, value, doc) { #type, XSTR(name), &name,      NOT_PRODUCT_ARG(doc) Flag::Flags(Flag::DEFAULT | Flag::KIND_LLVM | Flag::KIND_PRODUCT) },
#define LLVM_PD_PRODUCT_FLAG_STRUCT(    type, name,        doc) { #type, XSTR(name), &name,      NOT_PRODUCT_ARG(doc) Flag::Flags(Flag::DEFAULT | Flag::KIND_LLVM | Flag::KIND_PRODUCT | Flag::KIND_PLATFORM_DEPENDENT) },
#define LLVM_DIAGNOSTIC_FLAG_STRUCT(    type, name, value, doc) { #type, XSTR(name), &name,      NOT_PRODUCT_ARG(doc) Flag::Flags(Flag::DEFAULT | Flag::KIND_LLVM | Flag::KIND_DIAGNOSTIC) },
#define LLVM_DEVELOP_FLAG_STRUCT(       type, name, value, doc) { #type, XSTR(name), NAME(name), NOT_PRODUCT_ARG(doc) Flag::Flags(Flag::DEFAULT | Flag::KIND_LLVM | Flag::KIND_DEVELOP) },
#define LLVM_PD_DEVELOP_FLAG_STRUCT(    type, name,        doc) { #type, XSTR(name), NAME(name), NOT_PRODUCT_ARG(doc) Flag::Flags(Flag::DEFAULT | Flag::KIND_LLVM | Flag::KIND_DEVELOP | Flag::KIND_PLATFORM_DEPENDENT) },
#define LLVM_NOTPRODUCT_FLAG_STRUCT(    type, name, value, doc) { #type, XSTR(name), NAME(name), NOT_PRODUCT_ARG(doc) Flag::Flags(Flag::DEFAULT | Flag::KIND_LLVM | Flag::KIND_NOT_PRODUCT) },
#endif
...
#endif
#ifdef LLVM
 LLVM_FLAGS(LLVM_DEVELOP_FLAG_STRUCT, LLVM_PD_DEVELOP_FLAG_STRUCT, LLVM_PRODUCT_FLAG_STRUCT, LLVM_PD_PRODUCT_FLAG_STRUCT, LLVM_DIAGNOSTIC_FLAG_STRUCT, LLVM_NOTPRODUCT_FLAG_STRUCT)
#endif
