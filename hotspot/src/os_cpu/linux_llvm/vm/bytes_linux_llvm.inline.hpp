...
#ifndef OS_CPU_LINUX_LLVM_VM_BYTES_LINUX_LLVM_INLINE_HPP
#define OS_CPU_LINUX_LLVM_VM_BYTES_LINUX_LLVM_INLINE_HPP
...
#endif // OS_CPU_LINUX_LLVM_VM_BYTES_LINUX_LLVM_INLINE_HPP
